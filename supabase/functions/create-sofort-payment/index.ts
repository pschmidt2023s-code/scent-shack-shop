...
serve(async (req) => {
  ...
  try {
    console.log("=== SOFORT PAYMENT CREATION ===");
    ...
    console.log("Stripe initialized for Sofort");
    ...
    // Create Stripe Checkout Session for Sofort
    ...
    console.log("Stripe Sofort session created:", session.id);
    ...
    console.error("Sofort Payment Error:", error.message);
    return new Response(JSON.stringify({ 
      success: false, 
      error: error.message 
    }), {
