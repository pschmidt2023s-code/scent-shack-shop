...
DO $$ 
BEGIN 
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'review_votes' AND policyname = 'Review votes are viewable by everyone') THEN
...
DO $$ 
BEGIN 
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'review_votes' AND policyname = 'Users can vote on reviews') THEN
...
DO $$ 
BEGIN 
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'review_votes' AND policyname = 'Users can update their votes') THEN
...
DO $$ 
BEGIN 
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'review_votes' AND policyname = 'Users can delete their votes') THEN
...
-- Create index for newsletter subscriptions
...
DO $$ 
BEGIN 
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'newsletter_subscriptions' AND policyname = 'Anyone can subscribe to newsletter') THEN
...
DO $$ 
BEGIN 
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'newsletter_subscriptions' AND policyname = 'Newsletter subscriptions are private') THEN
...
-- Create function to update helpful_count on reviews (replace if exists)
