...
-- 1. Fix Newsletter Subscriptions - Block anonymous access completely
...
-- 2. Fix Coupons - Already has good admin-only policies, add anonymous blocking
...
-- 3. Fix Financial Data - Add explicit anonymous blocking for all financial tables
