    ...
    variants: [
      {
        id: 'sparkit-5-proben',
        number: 'SPAR5',
        name: 'Sparkit - 5x Proben',
        description: 'Stelle dir dein persönliches Sparkit zusammen! Wähle 5 beliebige Proben (5ml) aus unserem gesamten Sortiment und spare dabei. Perfekt, um verschiedene Düfte zu testen und deinen Favoriten zu finden.',
        price: 29.95,
        originalPrice: 34.75,
        inStock: true,
        rating: 4.9,
      ...
      },
      {
        id: 'sparkit-3x50ml',
        number: 'SPAR3',
        name: 'Sparkit - 3x 50ml Flakons',
        description: 'Spare beim Kauf von 3 beliebigen 50ml Flakons! Wähle aus unserem kompletten Sortiment deine drei Lieblingsdüfte aus und profitiere von einem attraktiven Bundle-Preis.',
        price: 129.99,
      ...
      },
      {
        id: 'sparkit-5x50ml',
        number: 'SPAR5F',
        name: 'Sparkit - 5x 50ml Flakons',
        description: 'Unser beliebtestes Sparkit! Wähle 5 beliebige 50ml Flakons aus unserem gesamten Sortiment und spare dabei maximal. Ideal für Duftliebhaber, die ihre Sammlung erweitern möchten.',
        price: 199.99,
