              ...
              <div className="space-y-3 p-4 bg-luxury-gray/20 border border-luxury-gold/30 rounded-lg">
                ...
                <div className="space-y-2">
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <label htmlFor="product_updates" className="text-sm cursor-pointer text-white">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <label htmlFor="promotions" className="text-sm cursor-pointer text-white">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <label htmlFor="tips" className="text-sm cursor-pointer text-white">
